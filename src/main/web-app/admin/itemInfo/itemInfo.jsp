...
<body>
	...
	<div class="layui-form-item">	
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="selcode" class="layui-input" id="selcode" placeholder="请输入商品码" />
			</div>
		...
		<div class="layui-inline">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="seldescr" class="layui-input" id="seldescr" placeholder="请输入描述" />
				</div>
				
				<div class="layui-inline">
					<input type="reset" id="reset" class="layui-btn" value="重置" />
					<input type="button" id="selectItem" class="layui-btn" value="查询" />
					<input type="button" id="addItem" class="layui-btn" value="添加" />
				</div>
			</div>
	...
	$("#addItem").click(function(){
		openLayer('/myMall/Admin/itemInfo/addItem.jsp',function(){				
			$("#selectItem").click();
		});		
...
/* 	
	//弹出层添加方法
	$("#addItemClass").click(function(){
		openLayer('/myMall/itemInfo/addItemClass.jsp',function(){				
			$("#selectItem").click();
		});		
	...
	//查询所有数据
	function selectAll(){
		ajax('/myMall/item/getCount.do',{"getCount":"1"},'text',function(data){
			//分页方法
			console.log(data);
	...
	function showData(curr,limit){
		var data = {"pageIndex":curr,"pageLimit":limit,"code":$("#selcode").val(),"descr":$("#seldescr").val()/* ,"parentCode":$("select[name=parentCode]") */}
		ajax('/myMall/item/showData.do',data,'JSON',function(data){
			var html = "";
			console.log(data);
	...
	function myupdate(code){
		openLayer('/myMall/Admin/itemInfo/updItem.jsp?code='+code,function(){				
			$("#selectItem").click();
		});
	...
	function mydelete(id){
		...
		var deldata = {"id":id}
		ajax('/myMall/item/delete.do',deldata,'text',function(data){
			if(data=="1"){
