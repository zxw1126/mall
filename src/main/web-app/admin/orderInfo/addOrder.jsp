	...
	<form class="layui-form" lay-filter="regform" >
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="userCode" class="layui-input" id="userCode" lay-verify="required" />
				</div>
			</div>
		</div>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="radio" name="state" value="未发货" title="未发货" checked/>
...
$("#sub").click(function(){
		...
		formSubmit('/myMall/order/addOrder.do','submit(regform)','text',function(resdata){
			if(resdata=="1"){
				$("#code").val("")
				layer.msg("注册成功");
				setTimeout(function(){
...
$("#code").blur(function(){
	if($("#code").val()!=""){
	console.log("进入测试编号方法")
	var testdata = {"code":$("#code").val()};
	ajax('/myMall/order/testCode.do', testdata,'text',function(data){
		if(data=="1"){
			$("#code").val("");
			layer.msg("订单号已存在");
		}
...
$("#userCode").blur(function(){
	if($("#userCode").val()!=""){
	console.log("进入测试编号方法")
	var testdata = {"code":$("#userCode").val()};
